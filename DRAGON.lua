...
if res ~= 200 then
print('\27[0;31m═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═ ━\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Bandaa2/Boyka/master/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/Bandaa2/DRAGON/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' 🛡️ تم تحديث السورس \n 🛡️ لديك اخر اصدار لسورس دراكون\n 🛡️ الاصدار » { v 1.6 }')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ℘' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 🛡️ اصدار سورس دراكون \n 🛡️ الاصدار »{ v 1.6 }')
end
...
send(msg.chat_id_, msg.id_,'🛡️  عدد الكروبات الان » { '..#group..' }'..DRAGONk..''..DRAGON..'\n🛡️  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n 🛡️ العضو » ['..result.title_..'](t.me/'..(username or 'S0DRG')..')'
status  = '\n 🛡️ تم ترقيته مطور'
...
usertext = '\n 🛡️ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
status  = '\n 🛡️ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🛡️ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'S0DRG')..') \n 🛡️ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," 🛡️ العضو : {["..data.first_name_.."](T.ME/S0DRG)}\n 🛡️ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🛡️ عذرا » {["..data.first_name_.."](T.ME/S0DRG)}\n 🛡️ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_, '🛡️ تم تفعيل تنبيه الاسماء')
...
send(msg.chat_id_, msg.id_, '🛡️ تم تعطيل تنبيه الاسماء')
...
send(msg.chat_id_, msg.id_, '🛡️ تم تفعيل تنبيه المعرف')
...
send(msg.chat_id_, msg.id_, '🛡️ تم تعطيل تنبيه المعرف')
...
send(msg.chat_id_, msg.id_, '🛡️ تم تفعيل تنبيه الصور')
...
send(msg.chat_id_, msg.id_, '🛡️ تم تعطيل تنبيه الصور')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 🛡️ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'S0DRG')..') \n 🛡️ تـم قفـل الدردشه ')
end,nil)   
...
Text = ' 🛡️ تم تفعيل امر كول'
database:del(bot_id..'Speak:after:me'..msg.chat_id_)  
else
Text = ' 🛡️ بالتاكيد تم تفعيل امر كول'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🛡️ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'S0DRG')..') \n 🛡️ تـم قفـل التاك بالكتم ')
end,nil)   
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Bandaa2/Boyka/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 🛡️ اهلا بك في متجر ملفات دراكون\n 🛡️ ملفات السورس ↓\n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═ٴ\n\n"
local TextE = "\n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═ٴ\n 🛡️ علامة تعني { ✔️ } ملف مفعل\n 🛡️ علامة تعني { ✖ } ملف معطل\n 🛡️ قناة سورس دراكون ↓\n".." 🛡️ [اضغط هنا لدخول](t.me/S0DRG) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Bandaa2/Boyka/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," 🛡️ عذرا الملف لايدعم سورس دراكون \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🛡️ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
status  = '\n 🛡️ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 🛡️ العضو » '..userid..''
...
send(msg.chat_id_, msg.id_, ' 🛡️ تم مسح جميع الحاتات')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
...
send(msg.chat_id_, msg.id_, ' 🛡️ تم مسح جميع الصاكين')
end
if text == ("تاك للصاكين") and Mod(msg) then
local list = database:smembers(bot_id..'Modde:User'..msg.chat_id_)
t = "\n 🛡️ قائمه صاكين الكروب \nٴ═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═ٴٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 🛡️ تم رفع العضــو الصاك في الكروب \n 🛡️ تعال حبي الصاك نطيني بوسه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
status  = '\n 🛡️ تم تنزيل العضــو الصاك من الكروب\n 🛡️ مشيي مو خوش صاك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
local  statuss  = '\n 🛡️ تم رفع ضلع في الكروب\n 🛡️ تعال حبيبي انت صرت من الضلوع حظر روحك منا ورايح نطلع سفرات للجزيره والزوراء ونشرب عرك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
status  = '\n 🛡️ تم تنزيل ضلع من الكروب\n 🛡️ بعد لتراويني وجهك ياحقير وجيب فلوس الشرب'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
local  statuss  = '\n 🛡️ تم رفع ضلعه في الكروب\n 🛡️ تعاي صرتي من ضلعاتي تمكيجي وخل نروح للمول نرقم صاكين'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
status  = '\n 🛡️ تم تنزيل ضلعه من الكروب\n 🛡️ دمشي ولي ملطخه وجهه تلطخ وتريد ترقم صاكين'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🛡️ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'S0DRG')..')'..'\n 🛡️ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,"🛡️تم مسح ردود المطور")
end
...
send(msg.chat_id_, msg.id_,"🛡️تم حفظ الرد بنجاح")
return false  
end  
end
...
send(msg.chat_id_, msg.id_,"🛡️تم ازالة الرد من قائمه ردود المطور")
...
send(msg.chat_id_, msg.id_,"🛡️تم مسح ردود المدير")
end
if text == ("ردود المدير") and Manager(msg) then
local list = database:smembers(bot_id.."List:Manager"..msg.chat_id_.."")
text = "🛡️قائمه ردود المدير \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═ٴ\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,"🛡️ارسل الكلمه التي تريد اضافتها")
...
send(msg.chat_id_, msg.id_,"🛡️ارسل الكلمه التي تريد حذفها")
...
send(msg.chat_id_, msg.id_,"🛡️تم ازالة الرد من قائمه الردود")
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_,' 🛡️ تم مغادرة الكروب') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
...
{
{text = 'اوامر التسليه', callback_data="/help7"},{text = 'الاضافات', callback_data="/hhgh"},
},
{
...
send(msg.chat_id_, msg.id_, t..'═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═ٴٴ\n🛡️ ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽. ](t.me/S0DRG)➤ ')
end
...
{
{text = ' 𓆩𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦𓆪', url="t.me/s_o_op"},
},
}
if Text == '/help2' then
if not Mod(data) then
