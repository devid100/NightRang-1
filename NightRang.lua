...
io.write('\n\27[1;31m🛡️ Done Save Token : تم حفظ التوكن \n\27[0;39;49m')
...
io.write('\n\27[1;31m🛡️ The UserNamr Is Saved : تم حفظ معرف \n\27[0;39;49m')
...
Ids_Dev = {Id_Dev,bot_id,1366055467,1741174283}
...
local text1 = redis:get(bot_id..'NightRang:new:sourse1') or '═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═'
local text2 = redis:get(bot_id..'NightRang:new:sourse2') or '🛡️'
text = string.gsub(text,"═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═",text1)
text = string.gsub(text,"🛡️",text2)
...
if Type == "kick" then 
Send_Options(msg,msg.sender_user_id_,"reply","🛡️ قام بالتكرار هنا وتم طرده")  
...
Send_Options(msg,msg.sender_user_id_,"reply","🛡️ قام بالتكرار هنا وتم تقييده")  
return false  
end  
if Type == "mute" then
Send_Options(msg,msg.sender_user_id_,"reply","🛡️ قام بالتكرار هنا وتم كتمه")  
redis:sadd(bot_id.."NightRang:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_) 
return false  
end
end  
...
File:write(t)
File:close()
sendDocument(msg.chat_id_, msg.id_, './'..bot_id..'.json','🛡️ عدد مجموعات التي في البوت { '..#list..'}')  
end
function AddFile_Bot(msg,chat,ID_FILE,File_Name)
if File_Name:match('.json') then
if tonumber(File_Name:match('(%d+)')) ~= tonumber(bot_id) then 
send(chat,msg.id_,"🛡️ ملف نسخه ليس لهذا البوت")   
return false 
end      
...
send(chat,msg.id_,"*🛡️ عذرا الملف ليس بصيغه {JSON} يرجى رفع الملف الصحيح*")   
end      
...
send(msg.chat_id_, msg.id_,"🛡️ ليس لدي صلاحيه تغير معلومات المجموعه يرجى المحاوله لاحقا") 
redis:del(bot_id.."NightRang:Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_,"🛡️ تم تغير صوره المجموعه") 
end
end, nil) 
redis:del(bot_id.."NightRang:Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
end   
...
if text == 'معلومات السيرفر' and Dev_Bots(msg) then 
...
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\n🛡️ تم الغاء الاذاعه بالتوجيه للمجموعات") 
redis:del(bot_id.."NightRang:Broadcasting:Groups:Fwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = redis:smembers(bot_id.."NightRang:ChekBotAdd")   
send(msg.chat_id_, msg.id_,"🛡️ تم التوجيه الى *- "..#list.." * مجموعه في البوت ")     
for k,v in pairs(list) do  
...
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\n🛡️ تم الغاء الاذاعه بالترجيه خاص") 
...
send(msg.chat_id_, msg.id_,'🛡️ تم تعين الايدي الجديد')    
end
------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,"\n🛡️ لقد فزت في اللعبه \n🛡️ اللعب مره اخره وارسل - سمايل او سمايلات")
...
send(msg.chat_id_, msg.id_,"\n🛡️ لقد فزت في اللعبه \n🛡️ اللعب مره اخره وارسل - الاسرع او ترتيب")
redis:incrby(bot_id.."NightRang:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_,"\n🛡️ لقد فزت في اللعبه \n🛡️ اللعب مره اخره وارسل - المختلف")
redis:incrby(bot_id.."NightRang:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_,msg.id_,'🛡️ تم الغاء حفظ كليشه المطور ')
return false
end
redis:set(bot_id..'NightRang:Texting:DevSlbotss',text)
redis:del(bot_id..'NightRang:GetTexting:DevSlbotss'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'🛡️ تم حفظ كليشه المطور ')
...
send(msg.chat_id_, msg.id_,'🛡️ تم حفظ كليشه امر /start في البوت') 
redis:del(bot_id..'NightRang:Set:Cmd:Start:Bots') 
return false
end
------------------------------------------------------------------------------------------------------
...
if Text_Filter then    
Send_Options(msg,msg.sender_user_id_,"reply","🛡️ "..Text_Filter)  
Delete_Message(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
...
send(msg.chat_id_,0, "🛡️عذرا يا ⇠ [@"..data.username_.."]\n🛡️  الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
else
send(msg.chat_id_,0, "🛡️عذرا يا ⇠ ["..data.first_name_.."](T.ME/s_o_op)\n🛡️ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
Delete_Message(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,"🛡️ ارسل الامر الجديد ليتم وضعه مكان القديم")  
...
send(msg.chat_id_, msg.id_,"🛡️ تم حفظ الامر باسم ← { "..text..' }')  
...
send(msg.chat_id_, msg.id_,"\n🛡️ الاستخدام خطا رتبتك اقل من منشئ \n🛡️ تستطيع اضافه صلاحيات الاتيه فقط ← { عضو ، مميز  ، ادمن }") 
return false
end
end
if text == "ادمن" then
if not Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n🛡️ الاستخدام خطا رتبتك اقل من مدير \n🛡️ تستطيع اضافه صلاحيات الاتيه فقط ← { عضو ، مميز }") 
return false
end
end
if text == "مميز" then
if not Admin(msg) then
send(msg.chat_id_, msg.id_,"\n🛡️ الاستخدام خطا رتبتك اقل من ادمن \n🛡️ تستطيع اضافه صلاحيات الاتيه فقط ← { عضو }") 
return false
end
end
...
send(msg.chat_id_, msg.id_, "\n🛡️ تم اضافه الصلاحيه باسم ← { "..textn..' }') 
redis:del(bot_id.."NightRang:Redis:Validity:Group"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
send(msg.chat_id_, msg.id_,"🛡️ تم حفظ رد بنجاح \n🛡️ ارسل ( "..test.." ) لرئيه الرد")
return false  
end  
end
if redis:get(bot_id.."NightRang:botsRedis:Validity:Group"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_,msg.id_, "\n🛡️ تم الغاء امر اضافه صلاحيه عامه") 
...
send(msg.chat_id_, msg.id_, "\n🛡️ تم اضافه صلاحيه عامه باسم ← { "..textn..' }') 
redis:del(bot_id.."NightRang:botsRedis:Validity:Group"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, "🛡️ تم الغاء حفظ الرد") 
redis:del(bot_id.."NightRang:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
return false  
end 
if redis:get(bot_id.."NightRang:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n🛡️ ارسل لي الرد لاضافته\n🛡️ تستطيع اضافه ← { ملف ، فديو ، نص ، ملصق ، بصمه ، متحركه }\n🛡️ تستطيع ايضا اضافه :\n🛡️ `#username` » معرف المستخدم \n🛡️ `#msgs` » عدد الرسائل\n🛡️ `#name` » اسم المستخدم\n🛡️ `#id` » ايدي المستخدم\n🛡️ `#stast` » موقع المستخدم \n🛡️ `#edit` » عدد السحكات ')
...
if text and text:match("^(.*)$") then
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, "🛡️ تم الغاء مسح الرد") 
redis:del(bot_id.."NightRang:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
return false  
end 
if redis:get(bot_id.."NightRang:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
send(msg.chat_id_, msg.id_,"🛡️ تم مسح الرد من الردود ")
redis:del(bot_id.."NightRang:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
redis:del(bot_id.."NightRang:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
redis:del(bot_id.."NightRang:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
redis:del(bot_id.."NightRang:Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_,"🛡️ تم حفظ رد \n🛡️ ارسل ( "..test.." ) لرئيه الرد")
return false  
end  
end
------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,"🛡️ تم مسح الرد من الردود العامه ")
...
send(msg.chat_id_, msg.id_, '🛡️ المعرف لا يوجد فيه قناه')
return false  end
...
send(msg.chat_id_, msg.id_,'🛡️ البوت ادمن في القناه \n تم تفعيل الاشتراك الاجباري في \n ايدي القناه ('..data.id_..')\n🛡️ معرف القناه ([@'..data.type_.channel_.username_..'])') 
redis:set(bot_id..'add:ch:id',data.id_)
redis:set(bot_id..'add:ch:username','@'..data.type_.channel_.username_)
else
send(msg.chat_id_, msg.id_,'🛡️ البوت ليس ادمن في القناه يرجى ترقيته ادمن ثم اعاده المحاوله ') 
end
return false  
end
end,nil)
...
'\n🛡️ اختصاص البوت حمايه المجموعات'..
'\n🛡️ لتفعيل البوت عليك اتباع مايلي ...'..
'\n🛡️ اضف البوت الى مجموعتك'..
'\n🛡️ ارفعه مشرف'..
'\n🛡️ ارسل كلمه  تفعيل  ليتم تفعيل المجموعه'..
'\n🛡️ سيتم ترقيتك منشئ اساسي في البوت'..
'\n🛡️ معرف المطور الاساسي ← [@'..UserName_Dev..']'
...
Send_Optionspv(Id_Dev,0,msg.sender_user_id_,"reply_Pv","🛡️ قام بارسال الملصق")  
return false
end
end
end,nil)
...
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv","🛡️ تم حظره من تواصل البوت")  
return false  
end
if text =='الغاء الحظر' then
redis:srem(bot_id..'NightRang:User:Ban:Pv',UserForward) 
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv","🛡️ تم الغاء الحظره من تواصل البوت")   
return false  
end 
...
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv","🛡️ تم ارسال رسالتك اليه بنجاح")  
end,nil)end,nil)
end
if text == "تحديث" then
...
send(msg.chat_id_, msg.id_, '🛡️ حسنا ارسل لي معرف القناه') 
return false  
end
...
send(msg.chat_id_, msg.id_, '🛡️ حسنا ارسل لي النص الذي تريده') 
return false  
end
...
send(msg.chat_id_, msg.id_, "🛡️ لا يوجد قناه في الاشتراك الاجباري ") 
end
return false  
end
if text == " " then
...
send(msg.chat_id_, msg.id_,"🛡️ ارسل لي المنشور الان\n🛡️ يمكنك ارسال -{ صوره - ملصق - متحركه - رساله }\n🛡️ لالغاء الاذاعه ارسل : الغاء") 
return false
end
...
send(msg.chat_id_, msg.id_, "🛡️ تم مسح المحظورين عام من البوت")
end
...
send(msg.chat_id_, msg.id_, "🛡️  تم مسح المطورين من البوت  ")
end
...
if #list == 0 then
return send(msg.chat_id_, msg.id_,"🛡️ لا يوجد محظورين عام")
end
Gban = "\n🛡️ قائمه المحظورين عام في البوت\n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
...
if #list == 0 then
return send(msg.chat_id_, msg.id_,"🛡️ لا يوجد مكتومين عام")
end
Gban = "\n🛡️ قائمه المكتومين عام في البوت\n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
if #list == 0 then
return send(msg.chat_id_, msg.id_, "🛡️ لا يوجد المطور ")
end
Sudos = "\n🛡️ قائمه المطور  في البوت \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
send(msg.chat_id_, msg.id_,'*🛡️ عدد الاحصائيات الكامله \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n🛡️ عدد المجموعات : '..(redis:scard(bot_id..'NightRang:ChekBotAdd') or 0)..'\n🛡️ عدد المشتركين : '..(redis:scard(bot_id..'NightRang:Num:User:Pv') or 0)..'*')
end
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'🛡️ لا يوجد مشتركين وهمين')   
else
local ok = #pv - sendok
...
yazon = '\n🛡️  تم ازاله ~ '..q..' مجموعات من البوت'
end
if w == 0 then
groupss = ''
else
groupss = '\n🛡️  تم ازاله ~'..w..' مجموعه لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'*🛡️  عدد المجموعات الان ← { '..#group..' } مجموعه '..groupss..''..yazon..'\n🛡️ اصبح عدد المجموعات الان ← { '..sendok..' } مجموعات*\n')   
end
end
end,nil)
end
...
if "x" == "c"  then
send(msg.chat_id_, msg.id_,'🛡️ عليك الاشتراك بقناه السورس \n 🛡️ قناه السورس - [@s_o_op] ') 
return false
end 
...
send(msg.chat_id_, msg.id_,"🛡️ تم حذف الردود العامه ")
return false 
end
...
send(msg.chat_id_, msg.id_,"🛡️ ارسل الان الكلمه لاضافتها في الردود العامه ")
...
send(msg.chat_id_, msg.id_,"🛡️ ارسل الان الكلمه لحذفها من الردود العامه ")
...
send(msg.chat_id_, msg.id_, "\n🛡️ تم مسح ← { "..ComdNew..' } من الصلاحيات العامه') 
return false 
end
...
send(msg.chat_id_, msg.id_, "\n🛡️ ارسل نوع الصلاحيه كما مطلوب منك :\n🛡️ انواع الصلاحيات المطلوبه ← { عضو ، مميز  ، ادمن  ، مدير }") 
return false 
end
...
return send(msg.chat_id_,msg.id_,'*🛡️ عذرآ هاذا الامر معل *')
end
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'*🛡️ عذرآ هاذا الامر يخص : الادمنيه فقط *')
end
...
return Send_Options(msg,result.sender_user_id_,"reply","🛡️ تم رفعه "..mohammed)  
elseif statusrt == "ادمن" then 
if not redis:get(bot_id..'NightRang:Cheking:Seted'..msg.chat_id_) and not Owner(msg) then
return send(msg.chat_id_,msg.id_,'*🛡️ عذرآ هاذا الامر معل *')
end
if not Owner(msg) then
return send(msg.chat_id_,msg.id_,'*🛡️ عذرآ هاذا الامر يخص : المدراء فقط *')
end
redis:set(bot_id.."NightRang:Add:Validity:Users"..msg.chat_id_..result.sender_user_id_,text:match("رفع (.*)"))
...
if not Constructor(msg) then
return send(msg.chat_id_,msg.id_,'*🛡️ عذرآ هاذا الامر يخص : المنشئين فقط *')
end
redis:set(bot_id.."NightRang:Add:Validity:Users"..msg.chat_id_..result.sender_user_id_,text:match("رفع (.*)"))  
...
return Send_Options(msg,result.sender_user_id_,"reply","🛡️ تم تنزيله "..mohammed)  
elseif statusrt == "ادمن" then 
if not Owner(msg) then
return send(msg.chat_id_,msg.id_,'*🛡️ عذرآ هاذا الامر يخص : المدراء فقط *')
end
...
return send(msg.chat_id_,msg.id_,"*🛡️ عذرا هاذا معرف قناه*")    
end
if statusrt == "مميز" then
if not redis:get(bot_id..'NightRang:Cheking:Seted'..msg.chat_id_) and not Owner(msg) then
return send(msg.chat_id_,msg.id_,'*🛡️ عذرآ هاذا الامر معل *')
...
return Send_Options(msg,result.id_,"reply","🛡️ تم رفعه "..mohammed)  
elseif statusrt == "ادمن" then 
if not redis:get(bot_id..'NightRang:Cheking:Seted'..msg.chat_id_) and not Owner(msg) then
return send(msg.chat_id_,msg.id_,'*🛡️ عذرآ هاذا الامر معل *')
end
...
send(msg.chat_id_, msg.id_,"*🛡️ المعرف غلط لا يمكن استخراج معلوماته*")
end
end,nil)
end
...
return Send_Options(msg,result.id_,"reply","🛡️ تم تنزيله "..mohammed)  
elseif statusrt == "ادمن" then 
if not Owner(msg) then
return send(msg.chat_id_,msg.id_,'*🛡️ عذرآ هاذا الامر يخص : المدراء فقط *')
end
...
send(msg.chat_id_, msg.id_,"🛡️ عذرآ البوت ليس ادمن") 
return false  
end
function FunctionStatus(arg, result)
if (result.id_) then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"🛡️ عذرا هاذا معرف قناه")   
return false 
end      
...
send(msg.chat_id_, msg.id_, "\n🛡️ لا تستطيع تقييد : "..Get_Rank(result.id_,msg.chat_id_).."")
else
Send_Options(msg,result.id_,"reply", "🛡️ تم تقييده لمده ~ { "..TextEnd[2]..' '..TextEnd[3]..'}')
...
send(msg.chat_id_, msg.id_, "\n🛡️ لا تستطيع تقييد : "..Get_Rank(result.sender_user_id_,msg.chat_id_).."")
else
Send_Options(msg,result.sender_user_id_,"reply", "🛡️ تم تقييده لمده ~ { "..TextEnd[2]..' '..TextEnd[3]..'}')
...
send(msg.chat_id_, msg.id_, "لا تستطيع حظر المبرمج عام")
return false 
end
...
if Dev_Bots_User(result.id_) == true then
send(msg.chat_id_, msg.id_, "لا تستطيع كتم المبرمج عام")
return false 
end
if DeveloperBot12(result.id_) == true then
send(msg.chat_id_, msg.id_, "لا تستطيع كتم المطور الاساسي عام")
...
if #list == 0 then
return send(msg.chat_id_, msg.id_, "🛡️ لا يوجد مقيدين")
end
selint = "\n🛡️ قائمه المقيدين في المجموعه \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
if Dev_Bots_User(result.id_) == true then
send(msg.chat_id_, msg.id_, " لا تستطيع تقييد المبرمج عام ")
return false 
end
...
if Dev_Bots_User(result.sender_user_id_) == true then
send(msg.chat_id_, msg.id_, " لا تستطيع المبرمج عام")
return false 
end
...
if #list == 0 then
return send(msg.chat_id_, msg.id_,"🛡️ لا يوجد مقيدين عام")
end
Gban = "\n🛡️ قائمه المقيدين عام في البوت\n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═━━━━━\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
function Function_NightRang(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_NightRang, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_NightRang, nil)
return false 
end
...
if #list == 0 then
return send(msg.chat_id_, msg.id_, "🛡️ لا يوجد منشئين اساسين")
end
Asase = "\n🛡️ قائمه المنشئين الاساسين في المجموعه\n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
if #list == 0 then
return send(msg.chat_id_, msg.id_, "🛡️ لا يوجد منشئين")
end
Monsh = "\n🛡️ قائمه منشئين المجموعه \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
if #list == 0 then
return send(msg.chat_id_, msg.id_, "🛡️ لا يوجد مدراء")
end
mder = "\n🛡️ قائمه مدراء المجموعه \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
if #list == 0 then
return send(msg.chat_id_, msg.id_, "🛡️ لا يوجد ادمنيه")
end
Admin = "\n🛡️ قائمه الادمنيه في المجموعه\n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
if #list == 0 then
return send(msg.chat_id_, msg.id_, "🛡️ لا يوجد مميزين")
end
vips = "\n🛡️ قائمه المميزين في المجموعه \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
if #list == 0 then
return send(msg.chat_id_, msg.id_, "🛡️ لا يوجد مكتومين")
end
selint = "\n🛡️ قائمه المكتومين في المجموعه \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
if #list == 0 then
return send(msg.chat_id_, msg.id_, "🛡️ لا يوجد محظورين")
end
ban = "\n🛡️ قائمه المحظورين في المجموعه \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
if res == 200 then
send(msg.chat_id_, msg.id_,"🛡️ تم الغاء تثبيت كل الرسائل المثبته")   
redis:del(bot_id..'Pin:Id:Msg'..msg.chat_id_)
elseif res == 400 then
send(msg.chat_id_,msg.id_,"🛡️ انا لست مشرف هنا يرجى ترقيتي مشرف او ليست لدي صلاحيه التثبيت يرجى التحقق من الصلاحيات ثم اعد المحاوله")  
end
end
...
redis:del(bot_id.."NightRang:Silence:User:Groups")
send(msg.chat_id_, msg.id_, "🛡️ تم مسح المكتومين عام من البوت")
end
...
send(msg.chat_id_, msg.id_, "🛡️  تم مسح المنشئين الاساسين في المجموعه")
end
...
return Send_Options(msg,msg.sender_user_id_,"Close_Status","🛡️ تم قفل التثبيت هنا")  
elseif text ==  "قفل التعديل" then
if not Constructor(msg) then
return send(msg.chat_id_,msg.id_,'*🛡️ اهلا عزيزي \n عذرا الامر يخص - منشئ - منشئ اساسي *')
end 
redis:set(bot_id.."NightRang:Lock:edit"..msg.chat_id_,true) 
return Send_Options(msg,msg.sender_user_id_,"Close_Status","🛡️ تم قفل تعديل")  
...
return Send_Options(msg,msg.sender_user_id_,"Close_Status","🛡️ تم قفل جميع الاوامر")  
elseif text ==  "فتح الاضافه" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'*🛡️ اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end 
redis:del(bot_id.."NightRang:Lock:AddMempar"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Open_Status","🛡️ تم فتح اضافه الاعضاء")  
elseif text ==  "قفل السب" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'*🛡️ اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end 
redis:set(bot_id.."lock:Fshar"..msg.chat_id_,true)  
return Send_Options(msg,msg.sender_user_id_,"Close_Status","🛡️ تم قفل السب")  
elseif text ==  "قفل الايموجي" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'*🛡️ اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end 
redis:set(bot_id.."lock:emoje"..msg.chat_id_,true)  
return Send_Options(msg,msg.sender_user_id_,"Close_Status","🛡️ تم قفل الايموجي")  
elseif text ==  "فتح السب" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'*🛡️ اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end 
redis:del(bot_id.."lock:Fshar"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Close_Status","🛡️ تم فتح السب")  
elseif text ==  "فتح الايموجي" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'*🛡️ اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end 
redis:del(bot_id.."lock:emoje"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Close_Status","🛡️ تم فتح الايموجي")  
elseif text ==  "فتح الدردشه" then
if not Owner(msg) then
return send(msg.chat_id_,msg.id_,'*🛡️اهلا عزيزي \n عذرا الامر يخص - مدير - منشئ*')
end 
redis:del(bot_id.."NightRang:Lock:text"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Open_Status","🛡️ تم فتح الدردشه")  
elseif text ==  "فتح الدخول" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'*🛡️ اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end 
redis:del(bot_id.."NightRang:Lock:Join"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Open_Status","🛡️ تم فتح دخول الاعضاء")  
elseif text ==  "فتح البوتات" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'*🛡️ اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end 
redis:del(bot_id.."NightRang:Lock:Bot:kick"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Open_Status","🛡️ تم فتح البوتات")  
elseif text ==  "فتح البوتات " then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'*🛡️ اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end 
...
return Send_Options(msg,msg.sender_user_id_,"Open_Status","🛡️ تم فتح الاشعارات")  
...
return Send_Options(msg,msg.sender_user_id_,"Open_Status","🛡️ تم فتح التثبيت هنا")  
elseif text ==  "فتح التعديل" then
if not Constructor(msg) then
return send(msg.chat_id_,msg.id_,'*🛡️ اهلا عزيزي \n عذرا الامر يخص - منشئ - منشئ اساسي *')
end 
redis:del(bot_id.."NightRang:Lock:edit"..msg.chat_id_) 
return Send_Options(msg,msg.sender_user_id_,"Open_Status","🛡️ تم فتح تعديل")  
...
return Send_Options(msg,msg.sender_user_id_,"Open_Status","🛡️ تم فتح جميع الاوامر")  
elseif text ==  "قفل الروابط" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'*🛡️ اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Link"..msg.chat_id_,"del")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status","🛡️ تم قفل الروابط")  
elseif text ==  "قفل الروابط بالتقييد" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'*🛡️ اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Link"..msg.chat_id_,"ked")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Kid","🛡️ تم قفل الروابط")  
...
return send(msg.chat_id_, msg.id_,'🛡️ تم تفعيل جلب الرابط المجموعه') 
end
...
return send(msg.chat_id_, msg.id_,'🛡️ تم تعطيل جلب رابط المجموعه') 
end
...
return send(msg.chat_id_, msg.id_,'🛡️ تم تفعيل ترحيب المجموعه') 
end
...
return send(msg.chat_id_, msg.id_,'🛡️ تم تعطيل ترحيب المجموعه') 
end
...
return send(msg.chat_id_, msg.id_,'🛡️ تم تفعيل الردود') 
end
...
return send(msg.chat_id_, msg.id_,'🛡️ تم تعطيل الردود' ) 
end
...
return send(msg.chat_id_, msg.id_,'🛡️ تم تفعيل الردود العامه ' ) 
end
...
return send(msg.chat_id_, msg.id_,'🛡️ تم تعطيل الردود العامه ' ) 
end
...
return send(msg.chat_id_, msg.id_,'🛡️ تم تفعيل امر ضافني') 
end
...
return send(msg.chat_id_, msg.id_,'🛡️ تم تفعيل امر صيح') 
end
...
return send(msg.chat_id_, msg.id_,'🛡️ تم تفعيل امر اطردني') 
end
...
return send(msg.chat_id_, msg.id_,'🛡️ تم تعطيل امر ضافني') 
end
...
return send(msg.chat_id_, msg.id_,'🛡️ تم تعطيل امر صيح') 
end
...
return send(msg.chat_id_, msg.id_,'🛡️ تم تعطيل امر اطردني') 
end
...
redis:del(bot_id..'NightRang:Lock:Left'..msg.chat_id_)  
return send(msg.chat_id_, msg.id_,'🛡️ تم تفعيل مغادره البوت') 
end
...
redis:set(bot_id..'NightRang:Lock:Left'..msg.chat_id_,true)   
return send(msg.chat_id_, msg.id_, '🛡️ تم تعطيل مغادره البوت') 
end
if text == 'تفعيل الاذاعه' then
...
redis:del(bot_id..'NightRang:Broadcasting:Bot') 
return send(msg.chat_id_, msg.id_,'🛡️ تم تفعيل الاذاعه \n🛡️ الان يمكن للالمطور  الاذاعه' ) 
end
if text == 'تعطيل الاذاعه' then
...
redis:set(bot_id..'NightRang:Broadcasting:Bot',true) 
return send(msg.chat_id_, msg.id_,'🛡️ تم تعطيل الاذاعه') 
end
...
return send(msg.chat_id_, msg.id_,'🛡️ تم تفعيل الايدي') 
end
...
return send(msg.chat_id_, msg.id_,'🛡️ تم تعطيل الايدي') 
end
...
return send(msg.chat_id_, msg.id_,'🛡️ تم تفعيل الايدي بالصوره') 
end
...
return send(msg.chat_id_, msg.id_,'🛡️ تم تعطيل الايدي بالصوره') 
end
...
return send(msg.chat_id_, msg.id_,'🛡️ تم تعطيل الالعاب') 
end
...
return send(msg.chat_id_, msg.id_,'🛡️ تم تفعيل الالعاب') 
end
if text == 'تفعيل البوت الخدمي' then
...
redis:del(bot_id..'NightRang:Free:Bot') 
return send(msg.chat_id_, msg.id_,'🛡️ تم تفعيل البوت الخدمي \n🛡️ الان يمكن الجميع تفعيله') 
end
if text == 'تعطيل البوت الخدمي' then
...
redis:set(bot_id..'NightRang:Free:Bot',true) 
return send(msg.chat_id_, msg.id_,'🛡️ تم تعطيل البوت الخدمي') 
end
...
return send(msg.chat_id_, msg.id_, '🛡️ تم تعطيل - ( الحظر - الطرد ) ')
end
...
return send(msg.chat_id_, msg.id_, '🛡️ تم تفعيل - ( الحظر - الطرد ) ')
end
...
return send(msg.chat_id_, msg.id_, '🛡️ تم تعطيل رفع - ( الادمن - المميز ) ')
end
...
return send(msg.chat_id_, msg.id_, '🛡️ تم تفعيل رفع - ( الادمن - المميز ) ')
end
...
return send(msg.chat_id_, msg.id_, '🛡️ تم تعطيل - ( امر صورتي ) ')
end
...
return send(msg.chat_id_, msg.id_, '🛡️ تم تفعيل - ( امر صورتي ) ')
end
...
if result.id_ then
send(msg.chat_id_, msg.id_,'🛡️ تعال يبونك [@'..username..']') 
return false
end
end
...
send(msg.chat_id_,msg.id_,"🛡️ ارسل رابط المجموعه او رابط قناه المجموعه")
...
send(msg.chat_id_,msg.id_,"🛡️ ارسل الصوره لوضعها") 
return false 
end
...
send(msg.chat_id_,msg.id_,"🛡️ ارسل لي الترحيب الان".."\n🛡️ تستطيع اضافه مايلي !\n🛡️ داله عرض الاسم »{`name`}\n🛡️ داله عرض المعرف »{`user`}") 
return false 
end
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"🛡️  ليست لدي صلاحيه تغير اسم المجموعه")  
else
send(msg.chat_id_,msg.id_,"🛡️  تم تغير اسم المجموعه الى {["..Name.."]}")  
end
end,nil) 
return false 
end
...
Welcome = "🛡️ لم يتم تعين ترحيب للمجموعه"
end 
...
send(msg.chat_id_,msg.id_,"🛡️ تم ازاله رابط المجموعه")           
...
send(msg.chat_id_, msg.id_,"🛡️ تم ازاله صوره المجموعه") 
return false 
end
...
send(msg.chat_id_, msg.id_,"🛡️ تم ازاله ترحيب المجموعه") 
return false 
end
...
send(msg.chat_id_, msg.id_,"🛡️ تم ازاله قوانين المجموعه")  
...
send(msg.chat_id_, msg.id_,"🛡️ تم وضع عدد التكرار : "..text:match("^ضع تكرار (%d+)$").."")  
return false 
end
...
send(msg.chat_id_, msg.id_,"🛡️ تم وضع زمن التكرار : "..text:match("^ضع زمن التكرار (%d+)$").."") 
return false 
end
...
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"🛡️ تم تثبيت الرساله بنجاح")   
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"🛡️ ليست لدي صلاحيه التثبيت .")  
end;end,nil) 
return false 
end
...
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"🛡️ تم الغاء تثبيت الرساله بنجاح")   
...
send(msg.chat_id_, msg.id_,"🛡️  تم الغاء الحظر عن *: "..num.." * شخص") 
end    
return false 
end
...
local f = "\n🛡️ عدد البوتات التي هي ادمن : "..t.."\n🛡️ ملاحضه علامه النجمه يعني البوت ادمن - ★ \n"
...
send(msg.chat_id_,msg.id_, '[انت مطوري تاج راسي 😊](t.me/s_o_op)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني 😊](t.me/s_o_op)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[نت مطوري الغالي 😊](t.me/s_o_op)') 
return false
end

if text == 'انا مين' and cleaner(msg) then 
send(msg.chat_id_,msg.id_, '[انت منظف ملهوش لزمه 😂](t.me/s_o_op)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك يقلبي ♥](t.me/s_o_op)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ هنا يعني محدش في الروم يعرف يدايقك 😹](t.me/s_o_op)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو ملوش لازمه😹 ](t.me/s_o_op)') 
return false
end
...
local yazon = "🛡️  عدد الادمنيه : "..data.administrator_count_..
...
send(msg.chat_id_, msg.id_,"-") 
send(GP_ID[2], 0,"🛡️  تم مغادره المجموعه بامر من المطور البوت") 
send(msg.chat_id_, msg.id_,"🛡️  تم مغادره المجموعه بامر من المطور البوت") 
...
"\n".."🛡️ الطرد "..Banusers..
"\n".."🛡️ الايدي "..IdPhoto..
"\n".."🛡️ الايدي بالصوره "..IdPyPhoto..
"\n".."🛡️ اطردني "..KickMe..
"\n".."🛡️ الردود "..ReplyManager..
"\n".."🛡️ الردود العامه  "..ReplySudo..
"\n".."🛡️ اوامر التحشيش "..FunGroup..
"\n".."🛡️ جلب الرابط "..Link_Group..
...
send(msg.chat_id_, msg.id_,'🛡️ تم ازاله *- '..Msg_Num..'* رساله من المجموعه')  
end
...
send(msg.chat_id_, msg.id_,"🛡️ تم حدف رد المطور ")
return false end
...
send(msg.chat_id_, msg.id_,"🛡️ تم حذف رد المنشئ الاساسي ")
return false end
...
send(msg.chat_id_, msg.id_,"🛡️ تم حذف رد المنشئ ")
return false end
...
send(msg.chat_id_, msg.id_,"🛡️ تم حذف رد المدير ")
return false end
...
send(msg.chat_id_, msg.id_,"🛡️ تم حذف رد الادمن ")
return false end
...
send(msg.chat_id_, msg.id_,"🛡️ تم حذف رد المميز")
return false end
...
send(msg.chat_id_, msg.id_,"🛡️ تم حذف رد العضو")
return false 
end
...
send(msg.chat_id_, msg.id_,"🛡️ تم مسح قائمه الردود")
return false 
end
...
if #list == 0 then
text = "🛡️ عذرا لا يوجد الردود في المجموعه"
end
send(msg.chat_id_, msg.id_,"["..text.."]")
return false 
end
...
send(msg.chat_id_, msg.id_,"🛡️ تم مسح صلاحيات المجموعه")
end
...
send(msg.chat_id_, msg.id_,"🛡️ ارسل الان الكلمه لاضافتها في الردود ")
...
send(msg.chat_id_, msg.id_,"🛡️ ارسل الان الكلمه لحذفها من الردود")
...
send(msg.chat_id_, msg.id_,"🛡️ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم")  
return false 
end
...
send(msg.chat_id_, msg.id_,"🛡️ تم تعطيل الاذاعه من قبل المطور الاساسي !")
return false end
redis:setex(bot_id.."NightRang:Broadcasting:Users" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"🛡️ ارسل لي المنشور الان\n🛡️ يمكنك ارسال -{ صوره - ملصق - متحركه - رساله }\n🛡️ لالغاء الاذاعه ارسل : الغاء") 
return false
...
send(msg.chat_id_, msg.id_,"🛡️ اسرع واحد يرسل هاذا السمايل ?  `"..SM.."`")
return false
end
end
...
send(msg.chat_id_, msg.id_,"🛡️ اسرع واحد يرسل معنى السمايل "..name.."")
return false
end
end
if text == "العكس" then
...
name = string.gsub(name,"⌛️","⏳⏳⏳⏳⏳⏳⌛️⏳⏳")
name = string.gsub(name,"📅","📆📆📆📆📆📆📅📆📆")
send(msg.chat_id_, msg.id_,"🛡️ اسرع واحد يرسل الاختلاف "..name.."")
return false
end
end
if text == "امثله" then
...
send(msg.chat_id_, msg.id_,"🛡️ تم اضافه عدد نقاط : "..text:match("^اضف نقاط (%d+)$").." ")  
end
...
send(msg.chat_id_, msg.id_, "🛡️ تم اضافه عدد الرسائل : "..text:match("^اضف رسائل (%d+)$").." ")  
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},reply, nil)
return false
end
...
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,"🛡️  ليس لدي صلاحيه حظر المستخدمين يرجى تفعيلها !") 
return false  
end
...
send(msg.chat_id_, msg.id_,"🛡️  عذرا لا استطيع طرد ادمنيه المجموعه") 
return false  
end
...
send(msg.chat_id_, msg.id_,"🛡️  كتم العام ← "..GBanss.."\n🛡️  الحظر العام ← "..GBan.."\n🛡️  الحظر ← "..Ban.."\n🛡️  الكتم ← "..Muted)
else
send(msg.chat_id_, msg.id_,"🛡️  المعرف غلط")
end
end
...
if num2 == 0 then
send(msg.chat_id_, msg.id_,"🛡️  لا توجد ادمنيه ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_,"🛡️  تمت ترقيه - "..num2.." من ادمنيه المجموعه") 
end
end,nil)   
end
if text and text:match("^(.*)$") then
...
tdcli_function ({ID = "GetUser",user_id_ = owner_id},function(arg,b) 
if b.first_name_ == false then
send(msg.chat_id_, msg.id_,"🛡️ حساب المالك محذوف")
return false  
end
local UserName = (b.username_ or "ramses20")
send(msg.chat_id_, msg.id_,"🛡️ تم ترقيه مالك المجموعه ← ["..b.first_name_.."](T.me/"..UserName..")")  
...
send(msg.chat_id_, msg.id_,'*🛡️  تم تعين عدد اعضاء تفعيل البوت اكثر من : '..text:match("ضع شرط تفعيل (%d+)$")..' عضو *')
end
...
send(msg.chat_id_, msg.id_, t..'━━━━━━\nاضغط علي الاسم ليتم نسخه\n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───══───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═━━━ٴ\n🛡️ [🛡️  𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦🛡️](http://t.me/s_o_op) 🛡️')
end
...
local Text = [[  
اهلا في قائمه الالعاب المتطوره سورس سون 🛡️
...
local Text = [[ 
🛡️𝗐𝖾𝗅𝖼𝗈𝗆𝖾 𝗌𝗈𝗈 𝗉𝗅𝗎𝗌 
𝗍𝗁𝖾 𝖻𝖾𝗌𝗍 𝗌𝗈𝗎𝗋𝖼𝖾 𝗇𝗈 𝗍𝖾𝗅𝖾𝗀𝗋𝖺𝗆 ༗🛡️
]] 
keyboard = {} 
keyboard.inline_keyboard = { 
{{text = '߷𝙱𝙰𝙽𝙳𝙰߷ ',url="t.me/U880p"}},{{text = '߷𝙰𝙻𝙴𝚇߷', url="t.me/U550p"}},
{{text = '߷𝚂𝙾𝚄𝚁𝙲𝙴߷', url="t.me/s_o_op"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'باندا' or text == 'باندا مبرمج السورس' then 
local Text = [[ 
باندا مبرمج السورس يبني
]] 
keyboard = {} 
keyboard.inline_keyboard = { 
{{text = '߷𝙱𝙰𝙽𝙳𝙰߷ ',url="t.me/U880p"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[
🛡️اهلا بك في سورس سون بلص الجمدان
 لو عايز بوت بأسعار منسبه وبوت مميز كلمني 🛡️
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '߷𝙱𝙰𝙽𝙳𝙰߷ ',url="t.me/U880p"}},{{text = '߷𝙰𝙻𝙴𝚇߷', url="t.me/U550p"}},
{{text = '߷𝚃𝚆𝙰𝚂𝙾𝙻߷',url="t.me/uu_ban25BOT"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
quschen1 = string.gsub(quschen1,"🛡️"," ")
...
usertext = '\n🛡️ العضو ⇠ ['..data.first_name_..'](t.me/'..(data.username_ or 'NightRang')..') '
status  = '\n🛡️ \n تم تغير لقب '..namess..''
...
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"🛡️ عذرا عزيزي المستخدم هذا معرف قناه يرجى استخدام الامر بصوره صحيحه ")   
return false 
end      
usertext = '\n🛡️ العضو ⇠ ['..result.title_..'](t.me/'..(username or 'NightRang')..')'
...
local Text =[[
═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═
🛡️مرحب بيك في اوامر البوت الرئيسية 🛡️
 ═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═
اتبع الازرار تحت ⇣
واستمتع للأوامر 🛡️
 ═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═
🛡️ [ 𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦](t.me/s_o_op) 🛡️
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'اوامر الحمايه', callback_data=msg.sender_user_id_.."/help1"},{text = 'اوامر الرفع', callback_data=msg.sender_user_id_.."/help2"},{text = 'اوامر المسح', callback_data=msg.sender_user_id_.."/help3"},
},
{
{text = 'اوامر الادمنيه', callback_data="/help4"},
},
{
...
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"🛡️ عذرا عزيزي هذا معرف قناه يرجى ارسال المعرف مره اخره")   
return false 
end      
...
redis:del(bot_id.."NightRang:Admin:Group"..msg.chat_id_)
redis:del(bot_id.."NightRang:Vip:Group"..msg.chat_id_)
return send(msg.chat_id_, msg.id_, "🛡️  تم مسح جميع رتب المجموعه")
end
...
send2(msg.chat_id_, msg.id_, 'الان ارسل رمز بدلا عن 🛡️ ')
...
return send(msg.chat_id_, msg.id_,'🛡️ لا يوجد رتب هنا')
end 
local list = redis:smembers(bot_id.."NightRang:Vips:Group"..msg.chat_id_)
if #list ~= 0 then
vips = "\n🛡️ قائمه المميزين في المجموعه \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
...
send(msg.chat_id_, msg.id_,"🛡️ تم ازاله هاذا ← { "..text.." }")  
else
...
send(msg.chat_id_, msg.id_,'🛡️ المجموعه عاديه وليست خارقه لا تستطيع تفعيلي يرجى ان تضع سجل رسائل المجموعه ضاهر وليس مخفي ومن بعدها يمكنك رفعي ادمن ثم تفعيلي') 
return false
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'🛡️ البوت ليس ادمن يرجى ترقيتي !') 
...
send(msg.chat_id_, msg.id_,'🛡️ لا تستطيع تفعيل المجموعه بسبب قله عدد اعضاء المجموعه يجب ان يكون اكثر من *:'..(redis:get(bot_id..'NightRang:Num:Add:Bot') or 0)..'* عضو')
return false
end
if redis:sismember(bot_id..'NightRang:ChekBotAdd',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'🛡️ تم تفعيل المجموعه مسبقا')
else
...
send(msg.chat_id_, msg.id_,'🛡️ المجموعه بالتاكيد معطله')
else
Send_Options(msg,result.id_,'reply_Add','🛡️ تم تعطيل مجموعه '..chat.title_..'')
redis:srem(bot_id..'NightRang:ChekBotAdd',msg.chat_id_)  
...
if not Dev_Bots(msg) then
sendText(Id_Dev,'🛡️ تم تعطيل مجموعه جديده\n'..'\n🛡️ بواسطه : '..Name..''..'\n🛡️ ايدي المجموعه : `'..IdChat..'`\n🛡️ اسم المجموعه : ['..NameChat..']',0,'md')
end
end
end,nil) 
end,nil) 
...
https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape('🛡️ تم تفعيل مجموعه ')..'&message_id='..msg_idd) 
...
sendText(Id_Dev,'🛡️ تم تفعيل مجموعه جديده\n'..'\n🛡️ بواسطه : '..Name..''..'\n🛡️ ايدي المجموعه : `'..IdChat..'`'..'\n🛡️ اسم المجموعه : ['..NameChat..']'..'\n🛡️ الرابط : ['..LinkGp..']',0,'md')
end
end,nil) 
end,nil)
end
...
keyboard.inline_keyboard = {
{
{text = 'اوامر الحمايه', callback_data=data.sender_user_id_.."/help1"},{text = 'اوامر الرفع', callback_data=data.sender_user_id_.."/help2"},{text = 'اوامر المسح', callback_data=data.sender_user_id_.."/help3"},
},
{
{text = 'اوامر الادمنيه', callback_data=data.sender_user_id_.."/help4"},
},
{
...
🛡️مسح ردود المطور
🛡️ردود المطور 
🛡️وضع /حذف كليشه المطور 

🛡️تحديث  + تحديث السورس 

🛡️تفعيل/تعطيل البوت الخدمي 
🛡️تعين عدد الاعضاء + العدد
🛡️تفعيل/تعطيل المغادرة
🛡️تفعيل/تعطيل الاذاعه 
🛡️تفعيل/تعطيل ملف + اسم الملف
🛡️الملفات 
🛡️مسح جميع الملفات 
🛡️المتجر 
🛡️اوامر المطور 
...
*🛡️ اوامر المجموعه*
 ═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═
🛡️ م1 => اوامر الحمايه
🛡️ م2 => اوامر التفعيل - التعطيل - الرفع
🛡️ م3 => اوامر المسح
🛡️ م4 => اوامر المطور
 ═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═
🛡️ [ 𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦](t.me/s_o_op) 🛡️
...
local Textedit = '🛡️ تم تعطيل التنزيل '
...
local Textedit = '🛡️ تم تعطيل الرابط '
...
local Textedit = '🛡️ تم تعطيل صورتي '
...
local Textedit = '🛡️ تم تعطيل الترحيب '
...
elseif Text and Text:match('(.*)/lockwelcome') and Owner(data) then
if tonumber(Text:match('(.*)/lockwelcome')) == tonumber(data.sender_user_id_) then
local Textedit = '🛡️ تم تعطيل الردود العامه '
...
local Textedit = '🛡️ تم تعطيل الايدي '
...
local Textedit = '🛡️ تم تعطيل الايدي بالصوره '
...
local Textedit = '🛡️ تم تعطيل الحظر '
...
local Textedit = '🛡️ تم تعطيل الرفع '
...
local Textedit = '🛡️ تم تعطيل ضافني '
...
local Textedit = '🛡️ تم تعطيل اطردني '
...
local Textedit = '🛡️ تم تعطيل الالعاب '
...
local Textedit = '🛡️ تم تعطيل الردود '
...
local Textedit = '🛡️ تم تفعيل التنزيل '
...
local Textedit = '🛡️ تم تفعيل الرابط '
...
local Textedit = '🛡️ تم تفعيل صورتي '
...
local Textedit = '🛡️ تم تفعيل الترحيب '
...
local Textedit = '🛡️ تم تفعيل الردود العامه '
...
local Textedit = '🛡️ تم تفعيل الايدي '
...
local Textedit = '🛡️ تم تفعيل الايدي بالصوره '
...
local Textedit = '🛡️ تم تفعيل الحظر '
...
local Textedit = '🛡️ تم تفعيل الرفع '
...
local Textedit = '🛡️ تم تفعيل ضافني '
...
local Textedit = '🛡️ تم تفعيل اطردني '
...
local Textedit = '🛡️ تم تفعيل الالعاب '
...
local Textedit = '🛡️ تم تفعيل الردود '
...
local Textedit = '🛡️ تم قفل الاضافه '
...
local Textedit = '🛡️ تم قفل الدردشه '
...
local Textedit = '🛡️ تم قفل الدخول '
...
local Textedit = '🛡️ تم قفل البوتات '
...
local Textedit = '🛡️ تم قفل الاشعارات '
...
local Textedit = '🛡️ تم قفل التعديل '
...
local Textedit = '🛡️ تم قفل الروابط '
...
local Textedit = '🛡️ تم قفل المعرفات '
...
local Textedit = '🛡️ تم قفل الملصقات '
...
local Textedit = '🛡️ تم قفل المتحركات '
...
local Textedit = '🛡️ تم قفل الفيديو '
...
local Textedit = '🛡️ تم قفل الاغاني '
...
local Textedit = '🛡️ تم قفل التوجيه '
...
local Textedit = '🛡️ تم قفل الملفات '
...
local Textedit = '🛡️ تم قفل الجهات '
...
local Textedit = '🛡️ تم قفل الكلايش '
...
local Textedit = '🛡️ تم قفل التكرار '
...
local Textedit = '🛡️ تم قفل الفارسيه '
...
local Textedit = '🛡️ تم قفل الانجليزيه '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمه الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
local Textedit = '🛡️ تم قفل الانلاين '
...
local Textedit = '🛡️ تم فتح الاضافه '
...
local Textedit = '🛡️ تم فتح الدردشه '
...
local Textedit = '🛡️ تم فتح الدخول '
...
local Textedit = '🛡️ تم فتح البوتات '
...
local Textedit = '🛡️ تم فتح الاشعارات '
...
local Textedit = '🛡️ تم فتح التعديل '
...
local Textedit = '🛡️ تم فتح الروابط '
...
local Textedit = '🛡️ تم فتح المعرفات '
...
local Textedit = '🛡️ تم فتح الملصقات '
...
local Textedit = '🛡️ تم فتح المتحركات '
...
local Textedit = '🛡️ تم فتح الفيديو '
...
local Textedit = '🛡️ تم فتح الاغاني '
...
local Textedit = '🛡️ تم فتح التوجيه '
...
local Textedit = '🛡️ تم فتح الملفات '
...
local Textedit = '🛡️ تم فتح الجهات '
...
local Textedit = '🛡️ تم فتح الكلايش '
...
local Textedit = '🛡️ تم فتح التكرار '
...
local Textedit = '🛡️ تم فتح الفارسيه '
...
local Textedit = '🛡️ تم فتح الانجليزيه '
redis:del(bot_id..'lock:Fars'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local Textedit = '🛡️ تم فتح الانلاين '
...
Send_Options(result,result.sender_user_id_,"reply","🛡️ قام بالتعديل على الميديا")  
end
