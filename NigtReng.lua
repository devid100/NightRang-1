...
Status = "انا البوت :) "
elseif redis:sismember(bot_id.."NightRang:Developer:Bot1", user_id) then
Status = redis:get(bot_id.."NightRang:Developer:Bot:Reply"..chat_id) or "قائد 🎖"  
elseif redis:sismember(bot_id.."NightRang:Developer:Bot", user_id) then
Status = redis:get(bot_id.."NightRang:Developer:Bot:Reply"..chat_id) or "قائد "  
elseif redis:sismember(bot_id.."NightRang:President:Group"..chat_id, user_id) then
...
local text1 = redis:get(bot_id..'NightRang:new:sourse1') or 'ــــــــــــــــــــــ❍ـــــــــــــــــــــ'
...
CmdStart = '\n• اهلا بك عزيزي \n انا بوت اسمي '..(redis:get(bot_id.."NightRang:Redis:Name:Bot") or "BLACK³")..''..
...
os.execute('wget https://raw.githubusercontent.com/jack1eljoker1/NightRang/main/NightRang.lua')
...
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id='..msg.chat_id_..'&caption='..URL.escape(Text)..'&photo='..'https://raw.githubusercontent.com/jack1eljoker1/NightRang/photo/master/'..numphotoid..'.jpg&reply_to_message_id='..Msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..msg.sender_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------
